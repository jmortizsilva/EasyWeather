...
_Última actualización: 8 de julio de 2026_

EasyWeather es una aplicación de previsión meteorológica. Esta política explica qué datos usa
la app y cómo los trata. En resumen: **EasyWeather no crea cuentas, no muestra publicidad, no
hace seguimiento de sus usuarios y no envía datos a servidores propios.**
...
La app obtiene los datos meteorológicos y la búsqueda de lugares de **Open-Meteo**
(https://open-meteo.com). Al pedir la previsión se le envían las coordenadas o el nombre
del lugar consultado. Consulta su política de privacidad en
https://open-meteo.com/en/terms para más información.
...
- No comparte tus datos con terceros más allá de la consulta meteorológica descrita.
