...
1. Instalad la app gratuita **TestFlight** desde el App Store (buscad "TestFlight",
   es de Apple).
...
- Cada versión de prueba **caduca a los 90 días**. Si la app deja de abrir con un aviso
  de caducidad, avisad a Jose María para que publique una versión nueva.
- Para enviar comentarios o informar de un fallo, podéis usar el botón de compartir /
  enviar feedback dentro de TestFlight, o simplemente decírselo a Jose María.

## Accesibilidad

TestFlight es totalmente compatible con VoiceOver, así que todo el proceso de instalación
y actualización se puede hacer con el lector de pantalla.
